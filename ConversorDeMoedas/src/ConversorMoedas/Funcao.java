...
public class Funcao {
	...
	public void converterMoedas (double valorRecebido) {
		String alternativas [] = {"De Reais a Doláres", "De Reais a Euros", "De Reais a Libras",
				"De Reais a Peso Argentino", "De Reais a Peso Chileno", "De Doláres a Reais", "De Euros a Reais",
		...
		String opcoes = (String) JOptionPane
				.showInputDialog (null, "Escolha a moeda para qual você deseja girar seu dinheiro", "Moedas",
						JOptionPane.PLAIN_MESSAGE, null, alternativas, "De Reais a Doláres").toString();
		switch (opcoes) {
		case "De Reais a Doláres":
